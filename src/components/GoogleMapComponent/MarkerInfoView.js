...
function MarkerInfoView(props) {
  ...
  return (
    <div className='InfoViewContainer'>
        ...
        <label className='info_title'>איש קשר: </label><label className='info_param'>{props.donation.creator}</label><br />
        ...
        {props.donation?.website && <><label className='info_title'>קישור לאתר: </label><a href={props.donation.website} className='info_param'>{props.donation.website}</a><br /></>}
